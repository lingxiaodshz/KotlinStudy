...
import com.lingxiao.kotlin.study.bean.HomeBean
import com.lingxiao.kotlin.study.retrofit.ErrorStatus
import com.lingxiao.kotlin.study.showToast
import com.lingxiao.kotlin.study.utils.StatusBarUtil
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            val options = activity?.let {
                ActivityOptionsCompat
                        .makeSceneTransitionAnimation(it, iv_search, iv_search.transitionName)
//                startActivity(Intent(activity,Sear))
            }
        }
    }
